    ...
    <View className="flex-1" style={{ backgroundColor: colors.card }}>
      ...
      >
                  ...
                  <SelectTrigger
                    ...
                    displayValue={
                      form.selectedCountry
                        ? `${form.selectedCountry.flag} ${form.selectedCountry.name}`
                        : ""
                    }
                  ...
                  <SelectTrigger
                    ...
                    displayValue={
                      form.selectedCurrency
                        ? `${form.selectedCurrency.symbol} ${form.selectedCurrency.name} (${form.selectedCurrency.code})`
                        : ""
                    }
              ...
              >
                <View className="mb-4">
                  ...
                  <SegmentControl
                    ...
                    onChange={(v) =>
                      form.setMeasurementSystem(v as "metric" | "imperial")
                    }
                  />
                </View>
                  ...
                  {form.measurementSystem === "metric" ? (
                    ...
                    <>
                      <View className="flex-row gap-4">
                        <View className="flex-1">
                          <NumberInput
                            ...
                            onChange={form.handleHeightFeetChange}
                            min={3}
                            max={8}
                            unit="ft"
                          />
                        ...
                        <View className="flex-1">
                          <NumberInput
                            ...
                            onChange={form.handleHeightInchesChange}
                            min={0}
                            max={11}
                            unit="in"
                          />
                      ...
                      <NumberInput
                        ...
                        onChange={form.handleWeightLbsChange}
                        min={66}
                        max={660}
        ...
        <SelectBottomSheet
          ...
          value={form.activityLevel || ""}
          onChange={(v) => form.setActivityLevel(v as any)}
        />
