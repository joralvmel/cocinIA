    ...
    ? [
        {
          ...
          icon: "calculator",
          color: "primary",
          onPress: form.handleCalculateGoals,
        },
      ]
    : [];
    ...
    <View className="flex-1" style={{ backgroundColor: colors.card }}>
      ...
      >
              ...
              >
                <View className="gap-4 mt-3">
                  <NumberInput
                    ...
                    onChange={form.setDailyCalorieGoal}
                    min={1000}
                    max={5000}
                    step={50}
                    unit="kcal"
                  ...
                  <View className="flex-row gap-4">
                    ...
                    <View className="flex-1">
                      <NumberInput
                        ...
                        onChange={form.setDefaultServings}
                        min={1}
                        max={12}
                      />
                    </View>
        ...
        <AlertModal
          ...
          title={
            form.alertType === "error" ? t("common.error") : t("common.done")
          }
          message={
            form.alertType === "calculated"
